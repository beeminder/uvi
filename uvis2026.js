...
x: `We now have consistent favicons (the icons on your browser tab) even for obscure URLs like https://beeminder.com/USER/GOAL.json`,
l: ["https://x.com/beemuvi/status/2087687265632075917",
    "https://github.com/beeminder/beeminder/issues/4704",
    "https://github.com/beeminder/beeminder/pull/5705"],
d: "2026-08-04",
e: "2026-08-12",
s: `Or for example https://www.beeminder.com/api/v1/auth_token.json the browser now uses the infinibee favicon on the tab. And certain tools that fetch favicons by convention rather than by requesting a page and parsing the html -- bookmark managers, rss readers, some search engine's results pages maybe, browser history/bookmarks -- can now use the correct beeminder favicon. Background: in January 2024 Bee moved the favicon and a couple other related/similar resources out of the Beeminder public folder and into the asset pipeline. Turns out that was not exactly a correct thing to do, because there are certain tools / use-cases where it is assumed that a favicon will exist as www.root.domain/favicon and that'll show up as slightly broken, or be missing if it's not there. The asset pipeline is nice because it fingerprints the file and so browsers can cache those files etc, but we still have control over how hard they cache them. When we change the asset the fingerprint changes. But then you also want it to be in the default place, for the instances where the tool doesn't actually read the html to find it. Solution: we keep the original in asset pipeline, and symlink to it from public dir. This 'just works' in the nginx/capistrano/git deploy env we use.`,
}, { // ------------------------------------------------------------------------
x: `Help docs: Rewording/additions in the "best way to beemind ___" article, plus tweaks for flow and clarity in 4 other articles`,
l: ["https://x.com/beemuvi/status/2088051262684332128",
    "https://help.beeminder.com/article/120-whats-the-best-way-to-beemind rewordings/additions",
    "https://help.beeminder.com/article/95-example-goal-learn-a-new-language",
    "https://help.beeminder.com/article/51-whats-the-difference-between-the-goal-types",
    "https://help.beeminder.com/article/336-how-many-goals-can-i-make-for-free",
    "https://help.beeminder.com/article/362-what-is-a-group-goal"],
...
x: `Our Postminder integration uses the Discourse icon on goal pages instead of the generic RSS icon, and consistently says "Postminder" not "RSSminder"`,
l: ["https://x.com/beemuvi/status/2088052547831714207",
    "https://github.com/beeminder/beeminder/issues/5285",
    "https://github.com/beeminder/beeminder/pull/5692"],
d: "2026-08-05",
e: "2026-08-13",
s: `Ie, Postminder now has thicker skin, ie, it's a less transparent skinning of the RSSminder integration`,
}, { // ------------------------------------------------------------------------
x: `Postminder polish/cleanup: Updated existing goals in the database and fixed a bug with goal setup's back button that'd flip you from Postminder to RSSminder`,
l: ["https://x.com/beemuvi/status/2088389880699396270",
    "https://github.com/beeminder/beeminder/issues/5285",
    "https://github.com/beeminder/beeminder/pull/5692"],
d: "2026-08-05",
e: "2026-08-14",
}, { // ------------------------------------------------------------------------
x: `Less wasted bandwidth on the dashboard; on very slow connections like train wifi the graph thumbnails will actually finish loading`,
l: ["https://x.com/beemuvi/status/2088390177207292098",
...
x: `On timey goals, the data entry +/- stepper buttons now speak HH:MM`,
l: ["https://x.com/beemuvi/status/2089501274870018119",
    "https://github.com/beeminder/beeminder/issues/5283",
    "https://github.com/beeminder/beeminder/pull/5703"],
d: "2026-08-17",
e: "2026-08-17",
}, { // ------------------------------------------------------------------------
x: `Added trailing 7-day mean to the statistics tab on the Goal page`,
l: ["https://x.com/beemuvi/status/2089502062187048983",
    "https://github.com/beeminder/beeminder/issues/2614",
    "https://github.com/beeminder/beeminder/pull/5721"],
d: "2026-08-17",
e: "2026-08-17",
}, { // ------------------------------------------------------------------------
x: `Added days-since-last-derail to the statistics tab on the Goal page`,
l: ["https://x.com/beemuvi/status/2089502471228146050",
    "https://github.com/beeminder/beeminder/issues/2614",
    "https://github.com/beeminder/beeminder/pull/5721"],
d: "2026-08-17",
e: "2026-08-17",
...
l: ["https://x.com/beemuvi/status/2095662308446126346",
    ...
    "https://github.com/beeminder/beeminder/pull/5646"],
e: "2026-09-03",
...
x: `In goal setup an invalid entry in plural goal units wouldn't get caught till you tried to save the goal, then failed mysteriously. #bugfix`,
l: ["https://x.com/beemuvi/status/2097835957479465467",
    "https://github.com/beeminder/beeminder/pull/5730"],
d: "2026-09-02",
e: "2026-09-09",
s: `We were only doing client-side validation on one of the fields. A user put something like "sessions" in the first field, and "10 minutes" in the second (plural) units field. When we didn't catch the error in real time before they could leave that step, then the whole goal save failed but was totally mysterious. "There was a problem setting up your goal"`,
}, { // ------------------------------------------------------------------------
x: `If goal creation fails with a helpful error message, we now consistently show you that message in the red error banner`,
l: ["https://x.com/beemuvi/status/2097838399306768456",
    "https://github.com/beeminder/beeminder/pull/5730"],
d: "2026-09-02",
e: "2026-09-09",
}, { // ------------------------------------------------------------------------
x: `Feet-wetting ($0 goals) were sometimes getting stuck for additional days at $0 if someone else's goal hit an error trying to feet-dry`,
l: ["https://x.com/beemuvi/status/2097838595017257217",
    "https://github.com/beeminder/beeminder/pull/5731"],
d: "2026-09-02",
e: "2026-09-09",
s: `Mysterious server-side error: the sweeper wasn't catching errors on the individual goals in its loop, so one goal threw an error somehow or other, and then everyone after them in the query were dangling at $0 until that one goal got deleted (for a few days in practice)`,
}, { // ------------------------------------------------------------------------
x: `Lifetime subscribers (grandfathered ones) could get locked out of making changes to their premium plan by clicking the "downgrade plan" button. #bugfix`,
l: ["https://x.com/beemuvi/status/2100009542881083543",
    "https://github.com/beeminder/beeminder/issues/5706",
    "https://github.com/beeminder/beeminder/pull/5733"],
d: "2026-09-03",
e: "2026-09-15",
s: `We've stopped selling lifetime plans but still honoring ones that were previously purchased. Reported by katriel.`,
}, { // ------------------------------------------------------------------------
x: `Graph regeneration is more robust: Previously we'd keep showing an error up to 5% of the time after an error happened once; now we wipe the slate clean. #bugfix`,
l: ["https://x.com/beemuvi/status/2100009671356723233",
    "https://github.com/beeminder/road/issues/340",
    "https://github.com/beeminder/road/pull/341"],
d: "2026-09-01",
e: "2026-09-15",
s: `A frozen/"wedged" page would get put back into the renderer's page pool, and then any time it tried to reuse that page again, it would fail to render. Now Beebrain kills the page and a new one is spun up when the server needs it. From the user's POV: Before: once an error happened once, then 1/20 graph renders from that server would fail. Now: basically it's less flaky.`,
}, { // ------------------------------------------------------------------------
x: `Similarly, we're more consistent with overnight graph regenerations, regenerating within 15 minutes when there's any kind of error`,
l: ["https://x.com/beemuvi/status/2100368242351214739",
    "https://github.com/beeminder/beeminder/pull/5734"],
d: "2026-09-04",
e: "2026-09-16",
s: `BB errors, graph image upload to Amazon S3 failures, Beebrain timing out. Now we set the "proctime" and "brainby" state back and re-brain timelily.`,
}, { // ------------------------------------------------------------------------
x: `The API no longer lets you set yaw or dir to nil, which is good since it breaks everything if you do`,
l: ["https://x.com/beemuvi/status/2100368369447027125",
    "https://github.com/beeminder/beeminder/issues/5613",
    "https://github.com/beeminder/beeminder/pull/5665"],
e: "2026-09-16",
s: `Months old but we never tweeted it till now`,
}, { // ------------------------------------------------------------------------
f: true,
x: `We now show both delta & total (and absolute deadline & countdown) on the dashboard and on the goal page header; click to toggle which is up-popped`,
l: ["https://x.com/beemuvi/status/2100735223508197424",
    "https://blog.beeminder.com/pop",
    "https://github.com/beeminder/beeminder/issues/1035",
    "https://github.com/beeminder/beeminder/pull/5737"],
d: "2026-09-15",
e: "2026-09-17",
s: `Up-popping vs down-popping`,
}, { // ------------------------------------------------------------------------
x: `Fixed an anti-magic violation (UVI#2445) where we suppressed the ability to see the absolute amount due on auto-summing goals in a misguided application of POLA`,
l: ["https://x.com/beemuvi/status/2100735340780916867",
    "https://blog.beeminder.com/pop",
    "https://github.com/beeminder/beeminder/issues/1035",
    "https://github.com/beeminder/beeminder/pull/5737"],
d: "2026-09-15",
